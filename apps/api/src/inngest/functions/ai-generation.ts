// apps/api/src/inngest/functions/ai-generation.ts
...
Follow these standards (Bolt.ai Professional Standard):
...
2. Return ONLY the exact JSON object described above.
3. No pre-text or post-text explanation outside the JSON. Do not include markdown code block syntax.
4. All relative paths in "fileUpdates" must contain complete, production-ready, compiling code.`;
}
