...
export function validateField(field: SchemaField, value: unknown): ValidationError[] {
...
export function validate(schema: ComponentSchema, data: Record<string, unknown>): ValidationResult {
